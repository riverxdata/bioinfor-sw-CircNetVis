...
#        }
  ...
  # })
    ...
    observeEvent(input$inputSpecies, {
      if (input$inputSpecies=="Mouse - mm9")
      #  browseURL("https://www.meb.ki.se/shiny/truvu/CircNetVis_mm9/")
        showModal(modalDialog(title="You selected Mouse - mm9", tags$a(href = "https://www.meb.ki.se/shiny/truvu/CircNetVis_mm9/","Click here to move")))
      
        updateSelectInput(session, "inputSpecies", selected = "Human - hg19")
    })
